...
$sql2= "INSERT INTO `AASalary` (`name`, `date`, `remarks`, `amount`, `datetime`, `time`, `role`, `project`, `find`, `type`, `user`, `addedby`, `updatedby`, `ext1`, `ex2`, `ext3`) VALUES ('$empid', '$empdate', '$empremarks', '$empamount', '$date', '$time', 'Restore', '$pid', '', 'grp', '$encUser', '$encId', '', 'true', '$mainB', '')";
