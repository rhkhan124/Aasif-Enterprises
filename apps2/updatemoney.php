...
require_once("con.php");
 ...
 $empid =$_GET["empid"];
 $empdate =$_GET["date"];
 $empremarks =$_GET["remark"];
 $empamount =$_GET["amount"];
 $empuid =$_GET["uid"];
 $myreq =$_GET["req"];
 
 $empdate2 =$_GET["date2"];
 $empremarks2 =$_GET["remark2"];
 $empamount2 =$_GET["amount2"];
...
$sql3= "UPDATE `$myreq` SET `date` = '$empdate', `remarks` = '$empremarks', `amount` = '$empamount', `updatedby` = '$encId' WHERE `id` = '$empuid'";
...
$alluser ="";
  ...
  $empdate =$newdate[2]."/".$newdate[1]."/".$newdate[0];
    ...
    $Adescription =$myreq2." updated ref id -".$empuid;
  $Atitle = "<b>".$focus."</b> ".$myreq2. " updated done <br> Date : ".$empdate2." Amount : ".$empamount2." Remarks : ".$empremarks2."<br>Changes<br>Date : ".$empdate." Amount : ".$empamount." Remarks : ".$empremarks;
  $Aref1 ="1";
  $Aref2 ="1";
  $Aref3 ="";
  $Aref4 ="";
