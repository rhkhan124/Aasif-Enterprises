...
$sql8= "SELECT * FROM `$myreq` WHERE `user`='$encUser' and `name`='$empid' and `date` >='$fdate' and `date`<='$ldate' ORDER BY `date` DESC";
...
$row1 = mysqli_fetch_assoc($result1);
 ...
 $uname2 =$row11['name'];
   ...
   echo '<div id="row'.$x.'" ><div class="mycontainer"style="width:96%;margin-bottom:3%;margin-left:2%;">'
   ...
   .'<tr>'
   .'<td class="F12" style="width:11%;text-align:center;font-family:times;font-weight:bold;"><input type="checkbox" onchange="change('.$x.');" value="'.$x.'" checked class="F12 check" style="width:17px;height:25px;"></td>'
   .'<td class="F14" style="width:26%;text-align:left;font-family:times;font-weight:bold;" >'.$x.'</td>'
   .'<td class="F14" style="width:26%;text-align:center;font-family:times;font-weight:bold;" id="dateb'.$x.'">'.$empdate.'</td>'
   .'<td class="F14" style="width:26%;padding-right:20px;text-align:right;font-family:times;font-weight:bold;" ><strong id="amountb'.$x.'">'.$empamount.'</strong><strong>/-</strong></td>'
   ...
   .'</tr>'
   .'<tr>'
   .'<td class="F10" style="padding-left:15px;text-align:left;font-family:times;font-weight:bold;" colspan="4" id="remarkb'.$x.'" >'.$empremarks.'</td>'
...
$row1 = mysqli_fetch_assoc($result1);
 ...
 $uname2 =$row11['name'];
   ...
   .'<tr style="height:15px;"><td colspan="2"></td><td colspan="2" style="text-align:right;" class="F8">Show transaction in employee application</td><td style="text-align:center;"><input type="checkbox" onchange="change2('.$x.')" '.$checked.' id="mycheck'.$x.'" class="F12 " style="width:17px;height:25px;margin:0px;padding:0px;"></td></tr>'
   .'<tr>'
   .'<td class="F12" style="width:11%;text-align:center;font-family:times;font-weight:bold;"><input type="checkbox"  onchange="change();" value="'.$x.'" checked class="F12 check" style="width:17px;height:25px;"></td>'
   .'<td class="F14" style="width:26%;text-align:left;font-family:times;font-weight:bold;" >'.$x.'</td>'
   .'<td class="F14" style="width:26%;text-align:center;font-family:times;font-weight:bold;" id="dateb'.$x.'">'.$empdate.'</td>'
   .'<td class="F14" style="width:26%;padding-right:20px;text-align:right;font-family:times;font-weight:bold;" ><strong id="amountb'.$x.'">'.$empamount.'</strong><strong>/-</strong></td>'
   ...
   .'<tr>'
   .'<td class="F10" style="padding-left:15px;text-align:left;font-family:times;font-weight:bold;" colspan="4" id="remarkb'.$x.'" >'.$empremarks.'</td>'
   .'<td style="width:11%;text-align:center;font-family:times;font-weight:bold;">';
   
   if($check3==1){echo '<button class="mybutton" style="outline:none;border:none;text-align:center;" onclick="rowdelete('.$x.');"><i class="fa fa-trash"></i></button>';}
...
$row1 = mysqli_fetch_assoc($result1);
 ...
 $uname2 =$row11['name'];
   ...
   if($check2==1){ echo '<button class="mybutton" style="outline:none;border:none;text-align:center;" data-toggle="collapse" data-target="#collapsetwo'.$x.'" aria-expanded="false" aria-controls="collapsetwo'.$x.'"><i class="fa fa-edit"></i></button>';}
   ...
   if($check4==1){echo '<button class="mybutton" style="outline:none;border:none;text-align:center;" onclick="rowdelete('.$x.');"><i class="fa fa-trash"></i></button>';}
