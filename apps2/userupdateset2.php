...
$queryA="UPDATE `AAuser` SET `mobile` = '', `email` = '', `role` = '', `password` = '', `verified` = '0', `image` = '0', `date` = '0000-00-00', `primium` = '0', `lastactive` = '', `ext2` = '', `project` = '', `permission` = '' WHERE `AAuser`.`id` = '$uid'";
