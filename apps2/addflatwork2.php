...
{
$req7 = "UPDATE `AAFlatwork` SET `emp` = '$name', `sqft` = '$sqft', `remark` = '$remark', `rate` = '$rate', `hold` = '$hold', `amount` = '$amount', `status` = '$payment', `date` = '$date', `addedby` = '$encId', `ext3`='' WHERE `user`='$encUser' and `project`='$project' and `wing`='$wing' and `bhk`='$bhk' and `flat`='$flat' and `work`='$work'";
