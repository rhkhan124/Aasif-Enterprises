...
$sql1= "SELECT * FROM `AAemployees` WHERE `user`='$encUser' and `type`='Main' and `role`='Restore'";
...
$empid =$row1['id'];
$sql8= "SELECT * FROM `AAPaid` WHERE `user`='$encUser' and `name`='$empid' ORDER BY `id` DESC";
