...
function all($encUser,$ref1,$ref2,$reqid,$con)
{
...
{
 $myid1 =$row1["id"];
echo $myname1 =$row1["filename"].",";
 $mycodename1 =$row1["filecodename"];
 $mytype1 =$row1["type"];
 ...
 {
 $myid2 =$row2["id"];
 echo $myname2 =$row2["filename"]."@";
 $mycodename2 =$row2["filecodename"];
 $mytype2 =$row2["type"];
 ...
 {
 $myid3 =$row3["id"];
 echo $myname3 =$row3["filename"]."@";
 $mycodename3 =$row3["filecodename"];
 $mytype3 =$row3["type"];
 ...
 {
 $myid4 =$row4["id"];
 echo $myname4 =$row4["filename"]."@";
 $mycodename4 =$row4["filecodename"];
 $mytype4 =$row4["type"];
...
all($encUser,$ref1,$ref2,$reqid,$con);
