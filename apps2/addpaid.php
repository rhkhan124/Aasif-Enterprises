...
$sql2= "INSERT INTO `AAPaid` (`id`, `name`, `date`, `remarks`, `amount`, `datetime`, `time`, `role`, `project`, `find`, `type`, `user`, `addedby`, `updatedby`, `ext1`, `ex2`, `ext3`) VALUES (NULL, '$empid', '$empdate', '$empremarks', '$empamount', '$date', '$time', 'Restore', '$pid', '', '', '$encUser', '$encId', '', '$hide', '', '')";
