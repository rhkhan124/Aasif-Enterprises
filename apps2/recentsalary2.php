...
$sql8= "SELECT * FROM `AASalary` WHERE `user`='$encUser' ORDER BY `datetime` DESC LIMIT 50";
...
$sql8= "SELECT * FROM `AASalary` WHERE `user`='$encUser' and `ex2`='$mainB' ORDER BY `datetime` DESC LIMIT 50";
$result8 = mysqli_query($con, $sql8);
while ($row8 = mysqli_fetch_assoc($result8))
{
$empid =$row8['name'];
