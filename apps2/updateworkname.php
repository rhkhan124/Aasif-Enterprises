...
if($type=="main")
{
  ...
  $queryB="UPDATE `AAWorkname` SET `sqft` = '$wsqft', `rate` = '$wrate' WHERE `AAWorkname`.`id` = $wid;";
...
if ($itemid > 0)
{
$req1 = "UPDATE `AAitem` SET `qty` = '$quantity', `unit` = '$unit' WHERE `AAitem`.`id` = $itemid;";
$reqR = mysqli_query($con, $req1);
}
else
{
...
$alluser ="";
  ...
  $find = "SELECT AAproject.name pname, AAWing.wing wing, AABhk.bhk bhk FROM AAproject, AAWing, AABhk WHERE AAproject.id='$project' and AAWing.id='$wing' and AABhk.id='$wbhk'";
  ...
  $Atitle = "Project ".$pname." ".$wingname." ".$bhkname. "<br> name : ".$wname."<br>Sqft : ".$wsqft."<br>Rate : ".$wrate."<br>work updated done";
  $Aref1 ="1";
  $Aref2 ="1";
  $Aref3 ="";
  $Aref4 ="";
