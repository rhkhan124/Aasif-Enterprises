...
$resulte2l = mysqli_query($con, $sqle2l);
  ...
  //for($i=0;$i<12;$i++)
    ...
    $MatchName="";
    $matchColor="";
	$sqle2 = "SELECT * FROM `spend` WHERE `user`='aasifenterprises09@gmail.com' AND `role`='Restore' AND ext2 between '$Tdate' and '$date' ORDER BY name DESC";
...
$MatchName=$Fname;
  ...
  $MatchName="";
  $matchColor="";
$sqle2 = "SELECT * FROM `spend` WHERE `user`='aasifenterprises09@gmail.com' AND `role`='Restore' AND ext2 between '$pvrs7' and '$pvrs72' ORDER BY name DESC";
$resulte2 = mysqli_query($con, $sqle2);
  while($rowe2 = mysqli_fetch_assoc($resulte2)) {
     $x = $x+1;
  $y = $y+$rowe2["amount"];
...
$pdf->Output('Weekly Report.pdf','F');
...
if (mail("aasifenterprises09@gmail.com,r4razaulhaque@gmail.com", "Weekly Report ", $nmessage, $header)) {
